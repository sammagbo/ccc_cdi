      ...
      <div className="animate-fade-in-up max-w-3xl w-full">
        ...
        <div className="relative max-w-2xl mx-auto transform transition-all hover:scale-[1.02]">
          ...
          <div className="relative flex items-center bg-white border-2 border-notebook-lines rounded-full shadow-lg overflow-hidden focus-within:border-blue-300 focus-within:ring-4 focus-within:ring-blue-100 transition-all">
            ...
            />
            <button className="hidden sm:block mr-2 px-6 py-3 bg-blue-900 text-white font-bold text-sm tracking-widest uppercase rounded-full hover:bg-black transition-colors">
              Chercher
            </button>
          </div>
        </div>
